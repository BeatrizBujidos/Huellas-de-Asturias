...
INSERT INTO epocas (id_epoca, nombre, descripcion, fecha_inicio, fecha_fin, caracteristicas) VALUES
...
INSERT INTO artistas (id_artista, nombre, apellidos, fecha_nacimiento, fecha_muerte, lugar_nacimiento, biografia, estilo, imagen) VALUES
...
INSERT INTO museos (id_museo, nombre, direccion, ciudad, latitud, longitud, horario, web, imagen) VALUES
...
INSERT INTO monumentos (id_monumento, id_epoca, nombre, fecha_construccion, descripcion, latitud, longitud) VALUES
...
(5, 3, 9, 'Pierrot', 1909, 'Óleo sobre lienzo', 'Es una de sus obras más conocidas y modificadas durante toda su carrera. La pintura muestra al personaje tradicional de la commedia dell'arte italiana, el Pierrot, conocido como el payaso triste que sufre por amor no correspondido, vestido con su característico traje holgado, a menudo blanco, con grandes botones, un gorro, y cuello con volantes, y maquillaje pálido. Valle retoma este arquetipo para reflejar la tensión entre lo espiritual y lo material, la melancolía y el humor, y la profundidad lírica de la vida.', '107 x 98 cm'),
...
SELECT 'Épocas:' AS Tipo, COUNT(*) AS Cantidad FROM epocas
UNION ALL
SELECT 'Artistas:', COUNT(*) FROM artistas
UNION ALL
SELECT 'Museos:', COUNT(*) FROM museos
UNION ALL
SELECT 'Monumentos:', COUNT(*) FROM monumentos
UNION ALL
